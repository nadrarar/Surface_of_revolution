...
bool Shader::Initialize(char * vertex_shader_file, char * fragment_shader_file)
{
	...
	this->do_cartoon_mode_handle= glGetUniformLocation(this->program_id, (const GLchar *) "do_cartoon_mode");
	this->camera_position_handle= glGetUniformLocation(this->program_id, (const GLchar *) "camera_position");
	glUseProgram(0);
